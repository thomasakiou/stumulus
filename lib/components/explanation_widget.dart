...
class _ExplanationWidgetState extends State<ExplanationWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ExplanationModel());
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: StreamBuilder<QuizRecord>(
          stream: QuizRecord.getDocument(widget.quiz!),
          builder: (context, snapshot) {
            ...
            return SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Text(
                    columnQuizRecord.review,
                    style: FlutterFlowTheme.of(context).bodyMedium.override(
                          fontFamily: 'Readex Pro',
                          letterSpacing: 0.0,
                        ),
                  ),
                  if ((columnQuizRecord.reviewImage != '') &&
                          ...
                          await Navigator.push(
                            ...
                            PageTransition(
                              ...
                              child: FlutterFlowExpandedImageView(
                                image: Image.network(
                                  columnQuizRecord.reviewImage,
                                  fit: BoxFit.contain,
                                ),
                                allowRotation: false,
                                tag: columnQuizRecord.reviewImage,
