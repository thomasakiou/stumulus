  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<QuizSetRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<QuizSetRecord> categoryPageQuizSetRecordList = snapshot.data!;
            ...
            body: InkWell(
              ...
              child: Stack(
                children: [
                  Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(0.0, 30.0, 0.0, 75.0),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (!FFAppState().SearchActive)
                            Builder(
                              builder: (context) {
                                final quizsetnosearch =
                                    categoryPageQuizSetRecordList.toList();
                                return ListView.builder(
                                  padding: EdgeInsets.zero,
                                  primary: false,
                                  shrinkWrap: true,
                                  scrollDirection: Axis.vertical,
                                  itemCount: quizsetnosearch.length,
                                  itemBuilder: (context, quizsetnosearchIndex) {
                                    final quizsetnosearchItem =
                                        quizsetnosearch[quizsetnosearchIndex];
                                    return Visibility(
                                      visible:
                                          quizsetnosearchItem.isNeco == false,
                                      child: Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            20.0, 20.0, 20.0, 0.0),
                                        child: InkWell(
                                                                ...
                                                                children: [
                                                                  TextSpan(
                                                                    text: valueOrDefault<
                                                                        String>(
                                                                      formatNumber(
                                                                        quizsetnosearchItem.duration.toDouble() /
                                                                            60000,
                                                                        formatType:
                                                                            FormatType.custom,
                                                                        format:
                            ...
                            Builder(
                              builder: (context) {
                                ...
                                return ListView.builder(
                                  ...
                                  shrinkWrap: true,
                                  scrollDirection: Axis.vertical,
                                  itemCount: noSearchNeco.length,
                                  itemBuilder: (context, noSearchNecoIndex) {
                                    final noSearchNecoItem =
                                        noSearchNeco[noSearchNecoIndex];
                                    return Visibility(
                                      visible: (valueOrDefault<bool>(
                                                  currentUserDocument?.isNeco,
                                                  false) ==
                                              true) &&
                                          (noSearchNecoItem.isNeco == true),
                                      child: Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            20.0, 20.0, 20.0, 0.0),
                                        child: AuthUserStreamWidget(
                                                                  ...
                                                                  children: [
                                                                    TextSpan(
                                                                      text: valueOrDefault<
                                                                          String>(
                                                                        formatNumber(
                                                                          noSearchNecoItem.duration.toDouble() /
                                                                              60000,
                                                                          formatType:
                                                                              FormatType.custom,
                                                                          format:
