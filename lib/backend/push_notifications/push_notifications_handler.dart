...
final parametersBuilderMap =
  ...
  'ScorePage': (data) async => ParameterData(
        allParams: {
  ...
  'CreateQuizSet': ParameterData.none(),
  ...
  'Description': (data) async => ParameterData(
        allParams: {
          'description': getParameter<DocumentReference>(data, 'description'),
        },
      ),
  'TimeUp': ParameterData.none(),
